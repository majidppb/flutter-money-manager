...
mixin _$NewOrUpdateTransactionState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(
            NewOrUpdateTransactionStatus status,
            String? purpose,
            double? amount,
            DateTime? date,
            CategoryType? type,
    ...
    return _then(_$LoadedImpl(
      status: null == status
          ...
          : status // ignore: cast_nullable_to_non_nullable
              as NewOrUpdateTransactionStatus,
...
class _$LoadedImpl implements Loaded {
  const _$LoadedImpl(
      {this.status = NewOrUpdateTransactionStatus.editing,
      this.purpose,
      this.amount,
      this.date,
      this.type,
...
abstract class Loaded implements NewOrUpdateTransactionState {
  ...
  NewOrUpdateTransactionStatus get status;
  String? get purpose;
  double? get amount;
  DateTime? get date;
